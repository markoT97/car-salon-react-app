...
import { addSeller } from "./../../../../../redux-store/tables/actions";
...
function InsertSellerForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values: any) => {
      ...
      dispatch(addSeller({ ...(values as RegisterModel), role: "Seller" }));
...
export default InsertSellerForm;
